...
Coredot Editor is MIT licensed and designed for forking, adaptation, and product-specific extension.
...
- Keep one clear scope.
- Preserve the documented route, provider, template, and plugin boundaries.
- Include tests for changed behavior.
- Update docs when public behavior changes.
- Avoid committing environment files, local databases, traces, or private document content.
