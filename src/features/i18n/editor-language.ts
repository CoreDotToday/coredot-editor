...
export const editorMessages = {
  en: {
    ...
    metadataPanel: {
      ...
      owner: "Owner",
      readiness: "Readiness",
      readinessApprovalDurability: "Approval waits until every collaboration change has confirmed durable storage.",
  ...
  ko: {
    ...
    metadataPanel: {
      ...
      owner: "소유자",
      readiness: "준비 상태",
      readinessApprovalDurability: "승인하려면 모든 공동 편집 변경 사항의 내구성 저장 확인이 필요합니다.",
